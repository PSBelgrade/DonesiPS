...
//                if (results.next()) s.setId(results.getInt("id"));
    ...
    @Override
    //Insert shop2 into the table Shops2
    public Shop2 insertShop2(Shop2 shop2) throws SQLException {
        ...
        try {
            ...
            //upit vraća id Shopa2 ukoliko postoji u bazi
            ...
            if (results.next()) {
                ...
                for (int i = 0; i < shop2.getMenu().size(); i++) {
                    ...
                    //upit vraća id dish-a ukoliko postoji u bazi
                ...
                //Insert the shop2
                Shop2 shop2new = new Shop2();
                shop2new = insertSh(shop2);
                insertShop2DishLink.setInt(1, shop2new.getId());
    ...
    public Dish insertDish(Dish dish) throws SQLException {
        ...
        if (results.next()) {
            ...
            //ResultSet tableKeys = insertDishLink.getGeneratedKeys();
            //tableKeys.next();
